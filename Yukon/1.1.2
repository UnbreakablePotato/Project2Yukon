...
void GameMovesPrint();
char GameMovesCheck(Node* currentFrom, Node* currentTo, const char* to);
            ...
            if ((Operations == 1) && (strcmp(Operation, "LD") == 0)) {
                ...
                while (strcmp(playOperation, "Q") != 0) {
                    ...
                    "INPUT >");
                        ...
                        }else if (playOperation[0] == 'C' || playOperation[0] == 'F'){
...
void GameMoves(const char* Operation) {
    ...
    if (card != NULL) {
        ...
        if (found == 0) {
            ...
            printf("card doesn't exist in specified column\n");
            return;
        }
        ...
        if (GameMovesCheck(currentFrom, currentTo, to)) {
...
void GameMovesPrint() {
    ...
    printf("c1\tc2\tc3\tc4\tc5\tc6\tc7\n\n");
    while (temp != NULL || list2 != NULL || list3 != NULL || list4 != NULL || list5 != NULL || list6 != NULL || list7 != NULL) {
        printf("%s\t", temp ? temp->value : " ");
        printf("%s\t", list2 ? list2->value : " ");
        printf("%s\t", list3 ? list3->value : " ");
        printf("%s\t", list4 ? list4->value : " ");
        printf("%s\t", list5 ? list5->value : " ");
        printf("%s\t", list6 ? list6->value : " ");
        printf("%s", list7 ? list7->value : " ");
...
char GameMovesCheck(Node* currentFrom, Node* currentTo, const char* to) {
    ...
    if (strcmp(to, "F1") == 0 || strcmp(to, "F2") == 0 || strcmp(to, "F3") == 0 || strcmp(to, "F4") == 0) {
        ...
        if (currentFrom->next != NULL) {
            printf("ERROR: card isn't bottom card\n");
            return 0;
        }

        if (currentTo->value == NULL || valTo[0] == '\0') {
            //check if first card in foundation is Ace
            if (rankFrom != 1) {
                printf("ERROR: foundation must start with Ace\n");
                return 0;
            }
        } else {
            //check if card moving is one highter than card in foundation
            if (rankFrom != rankTo + 1) {
                printf("ERROR: rank isn't one higher\n");
                return 0;
            }
            //checks if cards are of same suit
            if (suitFrom != suitTo) {
                printf("ERROR: suit is not the same\n");
                return 0;
            }
        }
    } else {

...
void GameMovesPrint();
char GameMovesCheck(Node* currentFrom, Node* currentTo);
...
void GameMoves(const char* Operation) {
    ...
    if (card != NULL) {
        ...
        if (GameMovesCheck(currentFrom, currentTo)) {
            //Splitting, split only if card isn't head
            ...
            //update the original heads with modified lists
            if (strcmp(from,"C1") == 0) {
                head = currentFrom;
            } else if (strcmp(from, "C2") == 0) {
            ...
            if (strcmp(to, "C1") == 0) {
                ...
                SecondHead = currentTo;
            }else if (strcmp(to, "C3") == 0) {
                ThirdHead = currentTo;
            }else if (strcmp(to, "C4") == 0) {
                FourthHead = currentTo;
            }else if (strcmp(to, "C5") == 0) {
                FifthHead = currentTo;
            }else if (strcmp(to, "C6") == 0) {
                SixthHead = currentTo;
            }else if (strcmp(to, "C7") == 0) {
                SeventhHead = currentTo;
            }else if (strcmp(to, "F1") == 0) {
                Fone = currentTo;
            }else if (strcmp(to, "F2") == 0) {
                Ftwo = currentTo;
...
char GameMovesCheck(Node* currentFrom, Node* currentTo) {
    ...
    if (currentTo == Fone || currentTo == Ftwo || currentTo == Fthree || currentTo == Ffour) {
